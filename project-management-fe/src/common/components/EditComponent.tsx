import {Alert, Button, Flex, Form, Input, InputNumber, message, Radio, Select, Space} from "antd";
            ...
            <div className="create-component">
                ...
                >
                    ...
                    <Form.Item label="Code" name="code" rules={[
                        ...
                        { pattern: /^[0-9]+$/, message: 'Project type must be a number' },
                    ]}>
                    ...
                    <Form.Item label="Type" name="project_type_id" rules={[{required: true, message: 'Type is required'}]}>
                        <Select size="large">
